...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>
                A client has cancelled their booking. The timeslot is now available again. Here are the details:
            </p>
            <div class="details">
                <table>
                    <tr>
            ...
            <p>The timeslot is now available for other clients to book.</p>
        </div>
        <div class="footer">
